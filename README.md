...
This repository is the iOS application for AyMusic.
...
```
2. Open `AyMusic.xcodeproj` in Xcode

## How to use the app (development mode)
1. Compile and run the app on your iOS device or simulator
2. Trust the developer certificate on your iOS device if you are running the app on a real device
3. Go to your iOS device's Settings > Apps > AyMusic and enable dev mode

## How to use the app (production mode)
1. Compile and run the app on your iOS device or simulator
2. Trust the developer certificate on your iOS device if you are running the app on a real device
